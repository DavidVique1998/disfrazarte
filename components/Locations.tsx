...
export default function Locations() {
  ...
  return (
    <section id="locales" className="py-24 px-5 md:px-12 bg-[#f5f8ff]">
          ...
          {locations.map((loc, i) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* CTA */}
                <div className="mt-6 pt-5 border-t border-black/6 flex gap-3">
                  <a
                    href={loc.mapsUrl}
                    target="_blank"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-none text-[#0a0a1a] text-xs font-bold tracking-wide bg-black/5 border border-black/8 hover:bg-black/8 transition-all"
                  >
